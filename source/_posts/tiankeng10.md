---
title: 填坑——强化学习——使用智能体来预测股票
date: 2024-05-17 11:27:00
tags: 填坑
---
## 背景介绍
[Gym Trading Env](https://gym-trading-env.readthedocs.io/en/latest/)Gym Trading Env is a Gymnasium environment for simulating stocks and training Reinforcement Learning (RL) trading agents. It was designed to be fast and customizable for easy RL trading algorithms implementation.
[如何用深度强化学习自动炒股](https://github.com/wangshub/RL-Stock)
[量化交易](https://github.com/Jack-Cherish/quantitative?tab=readme-ov-file)
...
```
[Baostack的API文档](http://baostock.com/baostock/index.php/Python_API%E6%96%87%E6%A1%A3)
## 选股器
思路，股票是波动的，但是波动是现象，可能今天是下跌，但是明天就上升了。

根据什么指标来构建筛选股票？，评价指标是什么?



### 聚宽平台
[聚宽数据](https://www.joinquant.com/help/api/help#name:aboutData)
...
### 本地化数据JQData
[JQData](https://www.joinquant.com/help/api/help#JQData:JQData)
QData由聚宽团队专门维护清洗，为金融机构、学术团体和量化研究者们提供的本地量化金融数据服务。 数据产品不仅对外服务，同时服务于聚宽所有业务线，历经平台40万用户、基金百亿资产、每年万亿交易额的考验。本着推动量化行业快速发展的良好愿景，JQData现已开放注册。


安装本地数据JQData`pip install jqdatasdk`
